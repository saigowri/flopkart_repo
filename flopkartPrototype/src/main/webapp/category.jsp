      ...
      <div class="header-top-inner">
        	<div class="cnt-account">
				<ul class="list-unstyled">
						...
						<li><a data-toggle="modal" data-target="#loginModal">Track Order</a></li>
          ...
          <div class="search-area">
            <form>
              <div class="control-group">
              	<div class="row">
              	<div class="col-md-10">
                	<input class="search-field" placeholder="Search for products, brands and more" />
                </div>
              	<div class="col-md-2">
          ...
          <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
            <div class="nav-outer">
              <ul class="nav navbar-nav">
                <li class="active dropdown yamm-fw"> <a href="index.jsp" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">Home</a> </li>
                <li class="dropdown yamm mega-menu"> <a href="category.jsp" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">Clothing</a>
                ...
                <li class="dropdown hidden-sm"> <a href="category.jsp">Health and Beauty <span class="menu-label new-menu hidden-xs">new</span> </a> </li>
...
<!-- ============================================== Testimonials: END ============================================== -->
		...
		</div> <!-- for <div class='row single-product'> -->
	</div> <!-- for <div class='container'> -->
</div> <!-- for <div class="body-content outer-top-xs"> -->
</body>
